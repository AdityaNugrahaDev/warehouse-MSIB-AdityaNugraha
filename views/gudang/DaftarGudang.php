...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet"> <!-- Mengimpor Bootstrap Icons -->
    ...
    <div class="container mt-4">
        ...
        <main>
            <div class="d-flex justify-content-between mb-4">
                ...
                <a href="Tambah.php" class="btn btn-primary"> <!-- Tombol tambah gudang -->
                    <i class="bi bi-plus-circle"></i> Tambah
                </a>
            </div>
            <table class="table table-bordered"> <!-- Tabel untuk menampilkan data gudang -->
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="Ubah.php?id=<?= $gudang['id'] ?>" class="btn btn-warning">
                                <i class="bi bi-pencil"></i> Ubah
                            </a>
                            <a href="Hapus.php?id=<?= $gudang['id'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus gudang ini?');">
                                <i class="bi bi-trash"></i> Hapus
                            </a>
                            <?php if ($gudang['status'] === 'aktif'): ?> <!-- Tombol untuk mengubah status menjadi tidak aktif -->
                                <a href="Status.php?id=<?= $gudang['id'] ?>&status=tidak_aktif" class="btn btn-secondary" onclick="return confirm('Apakah Anda yakin ingin mengubah status gudang ini menjadi tidak aktif?');">
                                    <i class="bi bi-x-circle"></i> Nonaktifkan
                                </a>
                            <?php else: ?>
                                <a href="Status.php?id=<?= $gudang['id'] ?>&status=aktif" class="btn btn-success" onclick="return confirm('Apakah Anda yakin ingin mengubah status gudang ini menjadi aktif?');">
